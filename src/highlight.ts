...
import { resolveAssignedIdentifier } from "./resolve.ts";
import { getSymbolReferencesWithinFile } from "./findallref.ts";
...
class Asn1HighlightProvider implements vscode.DocumentHighlightProvider {
    ...
    ): vscode.DocumentHighlight[] | Promise<vscode.DocumentHighlight[]> {
