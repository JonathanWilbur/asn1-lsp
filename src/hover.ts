...
import * as definitions from "./definitions/index.ts";
...
function provideDateHover(
    ...
    const contentString = dt.getFullYear().toString().padStart(4, "0")
        ...
        ;
    const contentOctets = asciiBytes(contentString);
...
function provideOctetStringHover(
    ...
    const sOnlyNybbles = s
        ...
        .replaceAll(/\s+/g, "")
        ;
    const bytes = hexBytes(sOnlyNybbles);
